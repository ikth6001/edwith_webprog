...
/**
 * items field 에 Category 들을 담는다
 */
@ApiModel(description = "items field 에 Category 들을 담는다")
@Validated
...
public class CategoryResponse   {
  ...
  public CategoryResponse items(List<Category> items) {
    this.items = items;
    return this;
  }

  public CategoryResponse addItemsItem(Category itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, categoryResponse.items);
  }
